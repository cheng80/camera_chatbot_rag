...
from backend.app.evaluation.card_answer_rewrite_eval import (  # noqa: E402
    DEFAULT_ANSWER_REWRITE_LIMIT,
    DEFAULT_ANSWER_REWRITE_MAX_TOKENS,
    DEFAULT_ANSWER_REWRITE_OUTPUT_PATH,
    card_answer_rewrite_model_ids,
    run_card_answer_rewrite_eval,
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = run_card_answer_rewrite_eval(
        settings=Settings(),
...
def _parse_args(argv: Sequence[str]) -> CliArgs:
    ...
    output_path = DEFAULT_ANSWER_REWRITE_OUTPUT_PATH
    limit = DEFAULT_ANSWER_REWRITE_LIMIT
    max_tokens = DEFAULT_ANSWER_REWRITE_MAX_TOKENS
    model_ids = card_answer_rewrite_model_ids()
    index = 0
